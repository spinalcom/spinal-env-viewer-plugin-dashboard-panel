...
import unlinkBmsNetworkNode from "./unlinkBmsNodePanel.vue";
...
const panels = [
  ...
  {
    name: "unlinkBmsNetworkToNode",
    vueMountComponent: vue.extend(unlinkBmsNetworkNode),
    panel: {
      title: "Unlink bmsNetwork to Node",
      closeBehaviour: "hide",
    },
    style: {
      width: "600px",
